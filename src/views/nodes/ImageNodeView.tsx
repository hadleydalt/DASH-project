    ...
    render() {
        ...
        return (
            ...
            : null}
                ...
                this.f1 + " contains " + folderArr.folders[0].folder.length + " notes": 
                this.state.addedTo===2? this.f2 + " contains " + folderArr.folders[1].folder.length + " notes" : 
                this.state.addedTo===3? this.f3 + " contains " + folderArr.folders[2].folder.length + " notes" : 
                this.state.addedTo===4? this.f4 + " contains " + folderArr.folders[3].folder.length + " notes" : 
                this.state.addedTo===5? this.f5 + " contains " + folderArr.folders[4].folder.length + " notes" : 
                this.state.addedTo===6? this.f6 + " contains " + folderArr.folders[5].folder.length + " notes" : 
                this.state.addedTo===7? this.f7 + " contains " + folderArr.folders[6].folder.length + " notes" : 
                this.state.addedTo===8? this.f8 + " contains " + folderArr.folders[7].folder.length + " notes" : 
                this.state.addedTo===9? this.f9 + " contains " + folderArr.folders[8].folder.length + " notes" : 
