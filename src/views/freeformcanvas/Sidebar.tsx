...
export function Sidebar() {
  ...
  /* Handles styling of the Sidebar */

  return (
    <div>
      <div className = "name-folder"><FolderCreator /></div> {/* Button to create and name Folders */ }
      <div className="youre-using">YOU'RE USING</div>
      <div className = "title">DASH!</div>
      <div className="add-new">ADD NEW</div> {/* Button to create new notes */ }
